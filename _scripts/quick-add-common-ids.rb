...
# Quick script to add some common/well-known spell IDs
# These are common tank abilities that are easy to identify

require 'yaml'

KEYBINDS_FILE = '_data/keybinds.yml'

# Common spell IDs - you can add more here
COMMON_IDS = {
  'warrior' => {
    'e' => 6572,      # Revenge
    'r' => 6343,      # Thunder Clap
  ...
  'druid' => {
    ...
    'c' => 22812,     # Barkskin
    'v' => 124974,    # Nature's Vigil (common alt CD)
  },
  'monk' => {
    'q' => 121253,    # Keg Smash
...
def main
  puts "Quick Add Common Spell IDs"
  puts "=" * 60
  puts "This will add common spell IDs for tank abilities."
  puts "Note: Some IDs may need verification on WoWHead.\n\n"
  ...
  if updates.empty?
    puts "No updates needed (all IDs already set or not found in common list)."
    return
  end
  
  puts "Will update #{updates.length} abilities:\n\n"
